...
Namespace SchedulerDragDropResizeExample
	Public Class MedicalAppointment
		...
		End Function
		Friend Shared Function Create(ByVal startTime As DateTime, ByVal endTime As DateTime, ByVal doctorId As Integer, ByVal paymentStateId As Integer, ByVal location As String, ByVal patientName As String, ByVal note As String, ByVal fixedTime As Boolean) As MedicalAppointment
