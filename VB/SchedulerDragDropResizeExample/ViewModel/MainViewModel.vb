...
Namespace SchedulerDragDropResizeExample
    Public Class MainViewModel
        ...
        Public Sub OnAppointmentDrag(ByVal e As DevExpress.Xpf.Scheduling.AppointmentItemDragDropEventArgs)
            If e.ViewModels.Count > 1 Then
                e.Allow = False
            End If
        End Sub
        #End Region ' #OnAppointmentDrag
        #Region "#OnAppointmentDrop"
        Public Sub OnAppointmentDrop(ByVal e As DevExpress.Xpf.Scheduling.AppointmentItemDragDropEventArgs)
            ...
            If draggedViewModel.CustomFields("FixedTime") IsNot Nothing Then
                If CBool(draggedViewModel.CustomFields("FixedTime")) AndAlso (draggedViewModel.Start <> draggedViewModel.Appointment.Start) Then
                    e.Allow = False
                End If
            End If
        End Sub
        ...
        Public Sub OnAppointmentResize(ByVal e As DevExpress.Xpf.Scheduling.AppointmentItemResizeEventArgs)
            If e.ViewModel.CustomFields("FixedTime") IsNot Nothing Then
                If CBool(e.ViewModel.CustomFields("FixedTime")) OrElse e.ResizedSide = DevExpress.XtraScheduler.ResizedSide.AtStartTime Then
                    e.Allow = False
                End If
            End If
        End Sub
